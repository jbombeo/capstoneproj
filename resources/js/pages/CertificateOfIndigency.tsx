...
export default function CertificateOfIndigency() {
  ...
  // ==========================
  return (
    <AppLayout breadcrumbs={[{ title: "Certificate of Indigency", href: "/certificate-of-indigency" }]}>
      ...
      <div className="flex justify-between items-center mb-8 bg-green-600 text-white shadow p-6">
        <h1 className="text-2xl font-bold">Certificate of Indigency Requests</h1>
        <Button
          ...
          <div className="grid grid-cols-3 gap-6 mt-10">
            ...
            <div className="col-span-1 pr-4 text-sm">
              <div className="p-4 rounded-lg shadow-md border border-blue-700 bg-blue-50">
                ...
                {skChairman && (
                  <p className="mt-2"><span className="font-bold text-[15px]">{skChairman.complete_name}</span><br />SK Chairman</p>
                )}
                {secretary && (
                  <p className="mt-3"><span className="font-bold text-[15px]">{secretary.complete_name}</span><br />Secretary</p>
                )}
                {treasurer && (
                  <p className="mt-3"><span className="font-bold text-[15px]">{treasurer.complete_name}</span><br />Treasurer</p>
                )}
              </div>
            </div>
