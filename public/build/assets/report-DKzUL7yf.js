import{u as D,r as p,j as e,H as N,b as u}from"./app-XOPTMjug.js";import{A as T}from"./app-layout-BmXM_f4V.js";import{d as C}from"./index-CDy59-5j.js";import{T as k,a as A,b as o,c as a,d as M,e as r}from"./table-ZlKnIIpZ.js";import{B as m}from"./button-D5dj0b15.js";import{I as g}from"./input-BbyJlRcP.js";import{L as f}from"./label-Dj8APtd9.js";import{s as _}from"./index-ikzcNs2d.js";import"./app-nfuc1qUJ.js";import"./utils-BAltloCr.js";import"./clsx-B-dksMZM.js";import"./index-Bw5zOxMT.js";import"./index-CVjkNEJV.js";import"./index-BhjRGQ5V.js";import"./index-Cdce5v5G.js";import"./x-Bv1O4pW9.js";import"./createLucideIcon-Bv13kPL-.js";import"./index-BEQwaIHq.js";import"./chevron-down-Vwy7lRkv.js";import"./index-BnwXxOQs.js";import"./log-out-CUpKvNT0.js";import"./users-DEeIWw72.js";import"./map-pin-XXaN1Jig.js";import"./file-text-D9QnVhaT.js";import"./clipboard-list-D2hxFQXo.js";import"./settings-BxToKCzk.js";import"./index-CMWG4mbA.js";const S=[{title:"Revenues Report",href:C().url}];function ne(){const{revenues:l,minDate:b,maxDate:j}=D().props,[s,x]=p.useState(b||""),[n,h]=p.useState(j||""),d=p.useRef(null),v=()=>{u.get(_("report.revenues"),{min_date:s,max_date:n},{preserveState:!0,preserveScroll:!0})},R=()=>{x(""),h(""),u.get(_("report.revenues"))},y=()=>{if(!d.current)return;const t="/images/logo.png",c=s||n?`Date Range: ${s||"Any"} to ${n||"Any"}`:"All Records",i=window.open("","_blank");i&&(i.document.write(`
      <html>
      <head>
