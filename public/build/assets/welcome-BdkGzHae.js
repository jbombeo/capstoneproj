import{j as e,L as a}from"./app-BYDD7jqK.js";/* empty css            */function r(){return e.jsxs("div",{className:"relative min-h-screen flex flex-col justify-between overflow-hidden",children:[e.jsx("div",{className:"absolute inset-0 bg-cover bg-center animate-bg-move",style:{backgroundImage:"url('/images/iponan.jpg')"}}),e.jsx("div",{className:"absolute inset-0 animated-bg"}),e.jsxs("header",{className:"z-20 w-full bg-green-900/90 text-white text-center py-3 text-sm",children:[e.jsx("h2",{className:"font-bold text-2xl tracking-wide",children:"Barangay System Portal"}),e.jsx("p",{className:"text-sm opacity-100",children:"Official Registration and Services Portal"})]}),e.jsx("div",{className:"z-20 flex justify-center mt-6",children:e.jsx("img",{src:"/images/logo.png",alt:"Barangay Emblem",className:"z-20 w-70 h-70 animate-pulse-slow drop-shadow-xl glow-border"})}),e.jsx("div",{className:"z-10 flex flex-col items-center mt-10 mb-10",children:e.jsxs("div",{className:"z-10 flex flex-col sm:flex-row gap-4 mt-10",children:[e.jsx(a,{href:"/dashboard",className:"btn-agency btn-blue",children:"Login"}),e.jsx(a,{href:"/resident/register",className:"btn-agency btn-blue",children:"Register Resident"}),e.jsx(a,{href:"/register",className:"btn-agency btn-blue",children:"Register"})]})}),e.jsxs("footer",{className:"z-20 w-full bg-green-900/90 text-white text-center py-3 text-sm",children:["© ",new Date().getFullYear()," Barangay Management System"]}),e.jsx("style",{children:`
        /* Slow pulsing emblem */
        .animate-pulse-slow {
